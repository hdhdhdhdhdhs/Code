...
t(K.job1, ['0','','-g','','3'], 'v = -29.4 m/s |   = -105.8 km/h |   via v=v0+at | dist = -44.1 m |   via d=v0t+at2/2')
...
t(K.job1, ['0','','g','','1min'], 'v = 588 m/s |   = 2117 km/h |   via v=v0+at | dist = 17640 m |   = 17.64 km |   via d=v0t+at2/2')
